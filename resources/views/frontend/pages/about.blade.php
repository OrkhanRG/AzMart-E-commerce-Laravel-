...
@section('content')
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="index.html">Anasəhifə</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Haqqımızda</strong></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6">
                    <div class="block-16">
                        <figure>
                            <img src="{{ asset($about->image ?? 'images/blog_1.jpg') }}" alt="Image placeholder" class="img-fluid rounded">
