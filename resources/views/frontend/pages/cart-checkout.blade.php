            ...
            <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                    ...
                    <div class="p-3 p-lg-5 border">
                        ...
                        <div class="form-group">
                            <label for="c_order_notes" class="text-black">Sifariş Qeydi</label>
                            <textarea name="c_order_notes" id="c_order_notes" cols="30" rows="5" class="form-control" placeholder="Sifariş qeydinizi bura yazın..."></textarea>
                        </div>
